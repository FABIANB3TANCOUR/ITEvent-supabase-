...
import 'main.dart'; // Tu pantalla destino invitado

class LoginInvitadoPage extends StatefulWidget {
  const LoginInvitadoPage({super.key});
...
class _LoginInvitadoPageState extends State<LoginInvitadoPage> {
  ...
  void login() {
    ...
    if (matricula == 'guest' && password == '1234') {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Login Invitado')),
      body: _loginForm(),
    );
  }
