        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                _FilterButton(label: "Todo"),
                _FilterButton(label: "Recomendado"),
                _FilterButton(label: "Categoría"),
              ],
            ),
          ),
          // Lista de asistentes
          Expanded(
            child: ListView(
              children: const [
                _AssistantCard(name: "David Arams", role: "Coordinador", location: "Ensenada, B.C."),
                _AssistantCard(name: "Jason Alexander", role: "Director", location: "Ensenada, B.C."),
                _AssistantCard(name: "Kathy Perez", role: "Organizadora", location: "Ensenada, B.C."),
                _AssistantCard(name: "Roberto Gomez", role: "Productor", location: "Sin especificar"),
              ],
            ),
          ),
...
class _AssistantCard extends StatelessWidget {
  ...
  const _AssistantCard({required this.name, required this.role, required this.location});
