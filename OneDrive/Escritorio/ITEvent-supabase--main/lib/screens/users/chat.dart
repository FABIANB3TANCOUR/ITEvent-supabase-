...
class _ChatPageState extends State<ChatPage> {
  ...
  final List<String> _palabrasProhibidas = ['tonto', 'menso', 'pendejo', 'idiota', 'estupido', 'mierda', 'verga',
  ...
  Future<void> verificarPermisoEnvio() async {
  print('🔍 Ejecutando verificarPermisoEnvio con idYo = $idYo');
  ...
  print('🛑 PERMISO DESDE SUPABASE: ${respuesta?['puede_enviar_mensajes']}');

  setState(() {
    puedeEnviar = respuesta?['puede_enviar_mensajes'] ?? true;
  });
}
  ...
  Future<void> _enviarMensaje() async {
    ...
    if (textoOriginal.isEmpty || !puedeEnviar) return;
        ...
        children: [
          ...
          const Divider(height: 1),
              ...
              : const Padding(
                  ...
                  child: Text(
                    'El envío de mensajes ha sido deshabilitado por el administrador.',
